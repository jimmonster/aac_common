 ...
 * @description :
 */
public class DetailTabAdapter extends BaseQuickAdapter<DetailBean.DataBean.ChildVosBean, BaseViewHolder>  {


    public DetailTabAdapter(int layoutResId, @Nullable List<DetailBean.DataBean.ChildVosBean> data) {
