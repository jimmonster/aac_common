...
public class BorderEffect implements BorderView.Effect {
    ...
    protected List<Animator> getMoveAnimator(View newFocus, int factorX, int factorY) {
        ...
        try {
            ...
            @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder valuesWithdHolder = PropertyValuesHolder.ofInt("width", oldWidth, newWidth);
            @SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder valuesHeightHolder = PropertyValuesHolder.ofInt("height", oldHeight, newHeight);
