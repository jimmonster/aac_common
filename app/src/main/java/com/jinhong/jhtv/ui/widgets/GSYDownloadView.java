 ...
 * @description :加载进度条
 */
public class GSYDownloadView extends View {
    ...
    private static final GSYDownloadView.DownloadUnit DEFAULT_DOWNLOAD_UNIT = GSYDownloadView.DownloadUnit.B;

    private GSYDownloadView.OnDownloadStateListener onDownloadStateListener;
    ...
    private GSYDownloadView.DownloadUnit mUnit;
    ...
    public GSYDownloadView(Context context) {
        super(context);
    }

    public GSYDownloadView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mCurrentState) {
            ...
            case STATE_DOWNLOADING:
                ...
                canvas.restore();
                if (mUnit != GSYDownloadView.DownloadUnit.NONE && mCurrentSize > 0) {
    ...
    private void downloadAnim() {
        ...
        mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mFraction = valueAnimator.getAnimatedFraction();
                if (mUnit != GSYDownloadView.DownloadUnit.NONE && mTotalSize > 0) {
    ...
    private String getUnitStr(GSYDownloadView.DownloadUnit unit) {
        switch (unit) {
            case GB:
                return " gb";
            case MB:
    ...
    public void setDownloadConfig(int downloadTime, double downloadFileSize, GSYDownloadView.DownloadUnit unit) {
    ...
    public void setOnDownloadStateListener(GSYDownloadView.OnDownloadStateListener onDownloadStateListener) {
