package com.jinhong.jhtv.CustomMedia;
 ...
 * @author :  Jim
 * @date :  2019-07-20
 * @description :标准播放器，继承之后实现一些ui显示效果，如显示／隐藏ui，播放按键等
 */
public class BaseGSYVideoPlayer extends GSYVideoPlayer {
     ...
     */
    public BaseGSYVideoPlayer(Context context, Boolean fullFlag) {
    ...
    public BaseGSYVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, BaseGSYVideoPlayer.this);
        }
        prepareVideo();
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        BaseGSYVideoPlayer sf = (BaseGSYVideoPlayer) from;
        BaseGSYVideoPlayer st = (BaseGSYVideoPlayer) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            BaseGSYVideoPlayer gsyVideoPlayer = (BaseGSYVideoPlayer) gsyBaseVideoPlayer;
    ...
    protected void updateStartImage() {
        if (mStartButton instanceof GSYPlayView) {
            GSYPlayView enPlayView = (GSYPlayView) mStartButton;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(BaseGSYVideoPlayer standardGSYVideoPlayer) {
